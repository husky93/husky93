...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,vue,html,css,redux,styledcomponents,sass,webpack,vite,next,firebase,jest,git&perline=7)](https://skillicons.dev)
